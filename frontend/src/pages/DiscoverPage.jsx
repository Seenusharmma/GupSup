...
import { MapPinIcon, CheckCircleIcon, UserPlusIcon, ArrowLeft } from "lucide-react";
    ...
    return (
        <div className="flex flex-col h-full w-full bg-wa-gray-50 dark:bg-wa-gray-800">
            ...
            <div className="h-[60px] flex items-center px-4 shrink-0 bg-wa-green text-white shadow-sm">
                <Link to="/" className="mr-4 p-2 rounded-full hover:bg-white/10 transition-colors lg:hidden">
                ...
                <div className="max-w-3xl mx-auto space-y-4">
                     <div className="bg-white dark:bg-wa-gray-700 rounded-lg shadow-wa overflow-hidden">
                        <div className="p-4 border-b border-wa-gray-100 dark:border-wa-gray-600 bg-wa-gray-50 dark:bg-wa-gray-700">
                            <h2 className="text-sm font-bold text-wa-green uppercase tracking-wide">Recommended for you</h2>
                        </div>
                        ...
                        {loadingUsers ? (
                             ...
                             <div className="p-8 text-center text-wa-gray-500 dark:text-wa-gray-400">No new recommendations available.</div>
                        ) : (
                                   ...
                                   <div key={user._id} className="flex items-center gap-3 p-4 hover:bg-wa-gray-50 dark:hover:bg-wa-gray-600 transition-colors cursor-pointer">
                                     ...
                                     <div className="flex-1 min-w-0">
                                       <div className="flex justify-between items-baseline mb-1">
                                         <h3 className="text-wa-gray-800 dark:text-wa-gray-100 font-semibold truncate">{user.fullName}</h3>
                                         <span className="text-xs text-wa-gray-400 flex items-center gap-1">
                                            {user.location && (
                                       ...
                                       <p className="text-sm text-wa-gray-500 dark:text-wa-gray-400 truncate flex items-center gap-2">
                                          <span className="flex items-center gap-1 text-xs bg-wa-gray-100 dark:bg-wa-gray-600 px-1.5 py-0.5 rounded">
                                            {getLanguageFlag(user.nativeLanguage)} {capitialize(user.nativeLanguage)}
                                          </span>
                                          <span className="text-wa-gray-400">→</span>
                                          <span className="flex items-center gap-1 text-xs bg-wa-gray-100 dark:bg-wa-gray-600 px-1.5 py-0.5 rounded">
